...
<body>
    <div class="d-flex">
        <div class="sidebar bg-dark text-white p-3">
            <div class="sidebar bg-dark text-white p-3">
                <nav class="nav flex-column" style="margin-top: 50px;"><a class="nav-link text-white active" href="../../../../Vista/html/paneles/PersonalMedico/index.php"><i class="fa-solid fa-chart-line"></i> citas</a>
                    <a class="nav-link text-white" href="../../../../Vista/html/paneles/PersonalMedico/calen.php"><i class="fas fa-users"></i> Calendario</a>
                    <a class="nav-link text-white" href="../../../../Vista/html/paneles/PersonalMedico/perfil.php"><i class="fas fa-user-md"></i> Perfil</a>
                </nav>
        </div>
                    ...
                    <div class="table-responsive" style="width: 90%;margin-left:70px; ">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT c.ID_cita, c.ID_Paciente, c.ID_Disponibilidad_fecha, f.Fecha_hora, c.Area_salud, c.Motivo, c.Estado_Cita, c.created_at, c.Asistencia
                            FROM citas c
