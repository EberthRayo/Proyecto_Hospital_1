...
if (isset($_SESSION['user_id'])) {
    ...
    $stmt = $conexion->prepare("SELECT nombre, foto_perfil, tipo_usuario, correo, descripcion_profesional, horario_trabajo FROM usuarios WHERE id = ?");
    $stmt->bind_param("i", $usuario_id);
    $stmt->execute();
    $stmt->bind_result($nombreUsuario, $fotoPerfil, $rol, $correo, $descripcion, $horario);
    $stmt->fetch();
    $stmt->close();
}
...
<body>
    <div class="container">
        <div class="profile-header">
            <img class="profile-pic" src="<?php echo $fotoPerfil; ?>" alt="Foto de perfil">
        ...
        <div class="profile-details">
            ...
            <ul>
                <li><strong>Nombre:</strong> <?php echo $nombreUsuario; ?></li>
                <li><strong>Horario de Trabajo:</strong> <?php echo $horario; ?></li>
                <li><strong>Descripción Profesional:</strong> <?php echo $descripcion; ?></li>
            </ul>
        </div>

        <div class="buttons">
            <a class="edit-profile-btn" href="#" id="editProfileBtn">Editar Perfil</a>
            <a class="back-btn" href="../../../../Vista/html/paneles/admind/index.php">Volver</a>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form id="editProfileForm" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="profileName" class="form-control" value="<?php echo $nombreUsuario; ?>">
                </div>
                <div class="form-group">
                    <label for="profileEmail">Correo Electrónico</label>
                    <input type="email" id="profileEmail" class="form-control" value="<?php echo $correo; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="profileHorario" class="form-control" value="<?php echo $horario; ?>">
                </div>
                <div class="form-group">
